...
const DEFAULT_PROVIDER_DEFINITIONS = [
  {
    ...
    capabilities: ['BROWSER', 'WEB_RESEARCH', 'WEB_NAVIGATION', 'INFORMATION_EXTRACTION', 'WEB_COMPARISON', 'SHOPPING', 'GROCERY', 'FOOD', 'PRODUCT_COMPARISON', 'PRICE_TRACKING', 'TRAVEL_RESEARCH', 'BUS', 'FLIGHT', 'TRAIN', 'HOTEL', 'TAXI', 'TRAVEL_BOOKING', 'FORMS', 'ACCOUNT_WORKFLOWS', 'FORM_SUBMISSION', 'MONITORING', 'COMMERCE', 'PAYMENTS_HANDOFF', 'ORDERS', 'RETURNS', 'TRACKING'],
    lifecycle: 'AVAILABLE',
    implemented: true,
